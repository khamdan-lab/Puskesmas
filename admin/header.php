...
<body>
    <!-- kode keamaan pada halaman header ketika user tidak memasukan username dengan passsword -->
    <?php
...
<?php if ($_SESSION ['sebagai'] == 'Apoteker') {
    echo "<script >alert('Bukan Hak Anda')</script>";
    echo "<script >location='../apoteker/menu.php'</script>";
